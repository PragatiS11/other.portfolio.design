		...
		<div ref={scrollRef}>
			...
			>
				...
				>
					...
					<h1>
					I'm an Aspiring full-stack web developer with a specialization in MERN stack 
					with a passion for learning with an endless supply of optimism and curiosity.
					</h1>
					<div className={styles.btn}>
						<a
							href={"https://drive.google.com/file/d/1oyHHUQBNF8GfDv7xZe6GbG8ZPuowvcVp/view?usp=sharing"} // Resume
							target='blank'
						>
							<Button
								text={
				...
				>
					<img
						src='https://raw.githubusercontent.com/PragatiS11/reactPracticeProject/main/image/img.jpeg' //my Picture
						alt='Profile pic'
					/>
				</div>
			</div>
